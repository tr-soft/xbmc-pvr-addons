...
std::string g_szBaseURL = "http://sledovanitv.cz/api/";

std::string g_szRegisteredDeviceId = "";
std::string g_szRegisteredPassword = "";

std::string g_szPhpSession = "";
...
extern "C" 
{
	...
	{
		static const char *strBackendName = "PVR Client for sledovani TV service";
		return strBackendName;
	}

	const char *GetBackendVersion(void)
	{
		static CStdString strBackendVersion = "1.0";
	...
	{
		snprintf(signalStatus.strAdapterName, sizeof(signalStatus.strAdapterName), "PVR adapter");
		snprintf(signalStatus.strAdapterStatus, sizeof(signalStatus.strAdapterStatus), "OK");
		signalStatus.iSignal = 0xffff;
		signalStatus.iSNR = 0xffff;
		snprintf(signalStatus.strProviderName, sizeof(signalStatus.strProviderName), g_szBaseURL.c_str());
