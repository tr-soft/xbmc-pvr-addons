...
{
	public:
		CDialogLogin(ADDON::CHelper_libXBMC_addon* xbmc, CHelper_libXBMC_gui* gui, std::string username, std::string password);
	...
	private:
		CAddonGUIEditControl *_editUsername;
		CAddonGUIEditControl *_editPassword;
